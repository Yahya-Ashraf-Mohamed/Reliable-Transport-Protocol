...
while True:
    ...
    try:
        ...
        while True:
           packet, client_address = s.recvfrom(1024)
           ...
           if packet_id == expected_packet_id and file_id == file_id_initial:
               print("recevied packet number ", packet_id)
        ...
        s.sendto(packet_header, client_address)
        print("Ack packet number ", packet_id)